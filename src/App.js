...
import i1 from "./assets/images/nfti.jpeg";
...
function App() {
  ...
  const claimNFTs = (_amount) => {
    ...
    setFeedback("Minting your CryptoDuckWalk...");
    setClaimingNft(true);
    blockchain.smartContract.methods
      .mint(blockchain.account, _amount)
      .send({
        gasLimit: "285000",
        to: '0x42d2dE1B7F401867E8F03eEBA6c7F29f645b33AC',
      ...
      .then((receipt) => {
        setFeedback(
          "WOW, you now own a NFT Minter. go visit Opensea.io to view it."
        );
        setClaimingNft(false);
  ...
  return (
    <s.Screen style={{ backgroundColor: "var(--black)" }}>
      <s.Container flex={1} ai={"center"} style={{ padding: 24 }}>
        ...
        >
          Mint a NFT From CryptoDuckWalk
        </s.TextTitle>
        <s.SpacerMedium />
            ...
            {Number(data.totalSupply) == 1000 ? (
              <>
                ...
                <s.TextDescription style={{ textAlign: "center" }}>
                  You can still find CryptoDuckWalk on{" "}
                  <a
                    target={"_blank"}
                    href={"https://testnets.opensea.io/0x8827c11ae45f32815010c27d3802892e57437847"}
                  >
                    Opensea.io
                  </a>
                </s.TextDescription>
